# CLD4ML Download Links

This file collects the dataset access and download links referenced by `README.md`.

Important:
- some links are official dataset pages or official portals
- some links are mirrors that appear to host accessible copies
- mirror availability does not imply official ownership or endorsement
- always verify provenance, licensing, and citation requirements before use
